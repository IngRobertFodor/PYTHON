...
try:
    ...
    horizontal_slider_link = wait.until(EC.presence_of_element_located((By.LINK_TEXT, "Horizontal Slider")))
    horizontal_slider_link.click()
    

    # 1.1  This checks header text on opened page.
    check_header_text = wait.until(EC.presence_of_element_located((By.XPATH, "//div[@class='example']/h3")))
    ...
    slider_check_value = wait.until(EC.presence_of_element_located((By.XPATH, "//span[@id='range']")))
